...
- [1. 導入](#1-導入)
   ...
   - [1.2. 主な特長](#12-主な特長)
   - [1.3. 対象者 (プロッター、サンドボックス、怠惰な GM)](#13-対象者-プロッターサンドボックス怠惰な-gm)
   - [1.4. はじめに](#14-はじめに)
   - [1.5. ボールトを v3 からアップグレードする](#15-ボールトを-v3-からアップグレードする)
- [2. インストール](#2-インストール)
   - [2.1. 最初のキャンペーンを設定する](#21-最初のキャンペーンを設定する)
   - [2.2. ユーザーインターフェイス](#22-ユーザーインターフェース)
- [3. 要素の概要](#3-要素の概要)
   ...
   - [3.3 要素](#33-要素)
     ...
     - [3.3.14. シーン](#3314-シーン)
   - [3.4. カスタム属性](#34-カスタム属性)
   - [3.5. タスク](#35-タスク)
   - [3.6. 要素テンプレート](#36-要素テンプレート)
